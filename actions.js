...
module.exports = {
	...
	getActions() {
		...
		actions['mix_assign_input'] = {
			...
			options: this.mixAssignOptions('Mix', qu['mixCount'], -1, qu['mixStereo'], ['Input channel', this.CHOICES_INPUT_CHANNEL])
		}
		actions['mix_assign_stereo'] = {
			label: 'Assign Stereo to Mix',
			options: this.mixAssignOptions('Mix', qu['mixCount'], -1, qu['mixStereo'], ['Stereo', this.CHOICES_STEREO_CHANNEL])
		}
		...
		actions['mutegrp_assign_input'] = {
			...
			options: this.mixAssignOptions('MuteGroup', qu['muteGroup'], -1, 0, ['Input Channel', this.CHOICES_INPUT_CHANNEL])
		}
		...
		actions['sendlev_input_mix'] = {
			...
			options: this.panOptions('Mix', qu['mixCount'], -1, qu['mixStereo'], ['Input channel', this.CHOICES_INPUT_CHANNEL], true)
		}
		if (this.config.model != 'QU16') {
		...
		actions['sendlev_stereo_mix'] = {
			...
			options: this.panOptions('Mix', qu['mixCount'], -1, qu['mixStereo'], ['Stereo', this.CHOICES_STEREO_CHANNEL], true)
		}
		if (this.config.model != 'QU16') {
